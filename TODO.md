...
- [x] Make default startup favor the authored track library once the unified engine is mature enough that curated tracks consistently outperform raw procedural playback.
